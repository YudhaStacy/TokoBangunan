            ...
            <form class="space-y-6" action="{{ route('login.submit') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2 flex items-center">
                        <input type="password" name="password" id="password" autocomplete="current-password" required
                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-0 -outline-offset-2 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                ...
                <div class="flex items-center justify-between">
                    <div class="text-sm flex items-center gap-2 ">
                        ...
                        <label for="remember" class="font-semibold text-gray-800">Tetap Login</label>
                    </div>
                    {{-- <div class="text-sm">
                        <a href="#"
